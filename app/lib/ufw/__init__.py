...
class Ufw(ShellLib):
    ...
    RULE_ACTION_CHOICES = [RULE_ACTION_ALLOW, RULE_ACTION_DENY, RULE_ACTION_REJECT]
    ...
    DEFAULT_DIRECTION_CHOICES = [DEFAULT_DIRECTION_INCOMING, DEFAULT_DIRECTION_OUTGOING, DEFAULT_DIRECTION_ROUTED]

    LOGGING_OFF = 'off'
    LOGGING_ON = 'on'
    LOGGING_CHOICES = [LOGGING_ON, LOGGING_OFF]

    LOGGING_LEVEL_LOW = 'low'
    LOGGING_LEVEL_MEDIUM = 'medium'
    LOGGING_LEVEL_HIGH = 'high'
    LOGGING_LEVEL_FULL = 'full'
    LOGGING_LEVEL_CHOICES = [LOGGING_LEVEL_LOW, LOGGING_LEVEL_MEDIUM, LOGGING_LEVEL_HIGH, LOGGING_LEVEL_FULL]
